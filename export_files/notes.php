<?php
    ...
    $clientes = isset($_SESSION["NOTES_CLIENTS"]) ? $_SESSION["NOTES_CLIENTS"] : FALSE;
    ...
    $pdf->SetTitle('Notas de pago para el periodo: ' . $fecha_periodo . " al " . $fin);
    $i = 0;
    ...
    $pdf->Image('../../sacc/assets/images/isisint.png', $pdf->GetX() , $pdf->GetY(), 45);
    $pdf->Cell(2, 30, '', 0, 0);
    ...
    $pdf->SetFont('Lilex','I',10);
    $pdf->Cell(0, 8, $fecha_periodo . ' al ' . $fin, 0, 1);
